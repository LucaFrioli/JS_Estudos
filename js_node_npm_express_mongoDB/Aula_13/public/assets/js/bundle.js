...
`, "",{"version":3,"sources":["webpack://./frontend/assets/css/style.css"],"names":[],"mappings":"AAEA;IACI,+BAA+B;IAC/B,sCAAsC;IACtC,qCAAqC;IACrC,mCAAmC;AACvC;;AAEA;IACI,sBAAsB;IACtB,UAAU;AACd;;AAEA;IACI,SAAS;IACT,UAAU;IACV,gCAAgC;IAChC,6BAA6B;IAC7B,oCAAoC;IACpC,gBAAgB;IAChB,kBAAkB;AACtB;;AAEA;IACI,gBAAgB;IAChB,iBAAiB;IACjB,aAAa;IACb,mBAAmB;IACnB,uCAAuC;AAC3C;;;AAGA;;;IAGI,cAAc;IACd,WAAW;IACX,oBAAoB;AACxB;;AAEA;IACI,kBAAkB;IAClB,YAAY;IACZ,kBAAkB;AACtB;;AAEA;IACI,yCAAyC;AAC7C;;AAEA;IACI,YAAY;IACZ,kBAAkB;IAClB,6BAA6B;IAC7B,uCAAuC;IACvC,eAAe;IACf,iBAAiB;IACjB,cAAc;IACd,eAAe;IACf,YAAY;IACZ,gBAAgB;AACpB;;AAEA;IACI,uCAAuC;IACvC,mBAAmB;IACnB,6BAA6B;IAC7B,sCAAsC;AAC1C;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,eAAe;IACf,UAAU;IACV,gBAAgB;AACpB","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;500;600;700;800&display=swap');\n\n:root {\n    --primary-color: rgb(5, 30, 59);\n    --primary-color-darker: rgb(0, 18, 43);\n    --secondary-color: rgb(241, 227, 163);\n    --terciary-color: rgb(35, 124, 226);\n}\n\n* {\n    box-sizing: border-box;\n    outline: 0;\n}\n\nbody {\n    margin: 0;\n    padding: 0;\n    background: var(--primary-color);\n    color: var(--secondary-color);\n    font-family: 'Open Sans', sans-serif;\n    font-size: 1.3em;\n    line-height: 1.5em;\n}\n\n.container {\n    max-width: 640px;\n    margin: 2rem auto;\n    padding: 2rem;\n    border-radius: 15px;\n    background: var(--primary-color-darker);\n}\n\n\nform input,\nform label,\nform button {\n    display: block;\n    width: 100%;\n    margin-bottom: 0.5em;\n}\n\nform input {\n    font-size: 1.15rem;\n    height: 30px;\n    padding: 20px 20px;\n}\n\nform input:focus {\n    outline: 1px solid var(--secondary-color);\n}\n\nform button {\n    border: none;\n    border-radius: 5px;\n    color: var(--secondary-color);\n    background-color: var(--terciary-color);\n    font-size: 17px;\n    font-weight: bold;\n    height: 1.7rem;\n    cursor: pointer;\n    padding: 7px;\n    margin-top: 30px;\n}\n\nform button:hover {\n    border: 1px solid var(--terciary-color);\n    border-radius: 10px;\n    color: var(--secondary-color);\n    background-color: var(--primary-color);\n}\n\nh1 {\n    font-size: 1.5rem;\n}\n\np.formError {\n    font-size: 12px;\n    color: red;\n    font-weight: 300;\n}\n"],"sourceRoot":""}]);
// Exports
...
// utilize o comando dentro do parenteses no terminal para iniciar o webpack: (npm run dev)
 ...
 //carrega arquivos qpara tronar a aplicação executável em navegadores mais antigos
 //idem ao anterior

var teste = "tudo que rola aqui s\xF3 \xE9 gerenciado pelo webpack";
alert(teste);
})();
